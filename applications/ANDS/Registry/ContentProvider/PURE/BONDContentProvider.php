...
class BONDContentProvider extends MetadataContentProvider
{
    ...
    public function loadContent($fileContent)
    {
        ...
        try{
            ...
            $mdNodes = $dom->documentElement->getElementsByTagName('dataSet');
            ...
            if($errors) {
                ...
                foreach ($mdNodes as $mdNode) {
                    ...
                    $record['nameSpaceURI'] = "https://pure.bond.edu.au";
