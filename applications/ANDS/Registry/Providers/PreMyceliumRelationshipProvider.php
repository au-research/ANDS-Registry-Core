 ...
 */
class PreMyceliumRelationshipProvider
{
    /**
    ...
    public static function hasRelatedClass(RegistryObject $record, $class)
    {
        ...
        $result = PreMyceliumConnections::getStandardProvider()
...
//        }
    ...
    public static function getDirectRelationship(RegistryObject $record)
    {
        ...
        $provider = PreMyceliumConnections::getStandardProvider();
    ...
    {
        $provider = PreMyceliumConnections::getImplicitProvider();
    ...
    {
        $provider = PreMyceliumConnections::getIdentifierProvider();
...
//            ->setFilter('to_key', $record->key)
    ...
    public static function getAffectedIDsFromIDs($ids, $keys)
    {
        ...
        $stdProvider = PreMyceliumConnections::getStandardProvider();
        ...
        // funder
        $impProvider = PreMyceliumConnections::getImplicitProvider();
        ...
        // identifier relationships
        $idenProvider = PreMyceliumConnections::getIdentifierProvider();
