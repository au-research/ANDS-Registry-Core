...
class CheckDescription extends CheckType
{
    protected $descriptor = [
        'service' => 'Includes a <a target="_blank" href="https://documentation.ardc.edu.au/display/DOC/Description">description</a> of the service for potential users',
        'activity' => 'Includes a <a target="_blank" href="https://documentation.ardc.edu.au/display/DOC/Description">description</a> of the activity to provide context for related collections'
    ];
