...
class QualityMetadataProvider
{
   ...
   // private static $metadataKeys = ['level_html', 'quality_html'];
    ...
    private static $metadataKeys = ['quality_info'];
    ...
    public static function checkLevelOneQuality($record, $xml){
        ...
        // test for key
        $key = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:key');
        ...
        $group = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/@group');
        ...
        $type = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/@type');
    ...
    public static function checkLevelTwoQuality($record, $xml){
        ...
        $primaryName = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:name[@type="primary"]');
        ...
        if($record->class == 'collection' || $record->class == 'activity') {
            ...
            // test description
            $brief_description = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:description[@type="brief"][string-length(.) > 0]');
            $full_description = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:description[@type="full"][string-length(.) > 0]');
        ...
        if($record->class == 'collection'){
            $description_right = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:description[@type="rights"][string-length(.) > 0]');
            $description_accessRights = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:description[@type="accessRights"][string-length(.) > 0]');
            $rights = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:rights[string-length(.) > 0]');
    ...
    public static function checkLevelThreeQuality($record, $xml){
        ...
        if($record->class == 'party'){
            ...
            $identifier = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:location/ro:address/[string-length(.) > 0]');
        ...
        if($record->class == 'collection'){
            ...
            $spatial_coverage = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:coverage/ro:spatial]');
            ...
            $temporal_coverage = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:coverage/ro:temporal/ro:date[@type="dateFrom" or @type="dateTo"]');
            ...
            $citationInfo = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:citationInfo');
            ...
            $dates = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:dates/ro:date');
        ...
        if($record->class == 'service'){
            $address = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:location/ro:address/ro:electronic[string-length(.) > 0]');
            ...
            $accessPolicy = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:accessPolicy[string-length(.) > 0]');
        ...
        if($record->class == 'party' || $record->class == 'activity'){
            ...
            $existenceDates = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:existenceDates');
        ...
        if($record->class == 'party' || $record->class == 'activity' || $record->class == 'collection') {
            ...
            $subject = XMLUtil::getElementsByXPathFromSXML($xml, 'ro:registryObject/ro:'.$record->class.'/ro:subject[string-length(.) > 0]');
