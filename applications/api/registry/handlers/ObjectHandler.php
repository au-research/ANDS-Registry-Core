...
class ObjectHandler extends Handler{
    ...
    private $valid_methods = array('core', 'descriptions', 'relationships', 'subjects', 'spatial', 'temporal', 'citations', 'dates', 'relatedInfo', 'identifiers', 'rights', 'contact', 'directaccess', 'logo', 'tags',
        'existenceDates', 'identifiermatch', 'suggest','jsonld', 'altmetrics','ARDC_campaign');
