...
;(function($) {
    ...
    $.fn.orcid_widget = function(options, param) {
		...
		var defaults = {
            ...
            search_endpoint: 'https://devl.ands.org.au/liz/registry/api/v2.0/orcid.jsonp/search/',
		   	lookup_endpoint: 'https://devl.ands.org.au/liz/registry/api/v2.0/orcid.jsonp/lookup/',
