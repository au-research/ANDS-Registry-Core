			...
			<div>	
			    <div class="box-content">
				    ...
				    <table class="table table-condensed" width="80%">
						...
						<tbody>				
							<tr>
								<td colspan="2"><?php  print_r($test_mint) ?></td>
							</tr>	
							<tr>
								<td colspan="2"><?php  print_r($test_functions) ?></td>
							</tr>																									
						</tbody>
						<thead>
							<tr>
						...
						<tbody>				
							<tr>
								<td colspan="2"><?php  print_r($authentication) ?></td>
							</tr>																									
						</tbody>
						<thead>
							<tr>
						...
						<tbody>				
							<tr>
								<td colspan="2"><?php  print_r($valid_xml) ?></td>
							</tr>																									
						</tbody>
						<thead>
							<tr>
						...
						<tbody>				
							<tr>
								<td colspan="2"><?php print_r($service_point) ?></td>
							</tr>																									
						</tbody>
						<thead>
							<tr>
						...
						<tbody>				
							<tr>
								<td colspan="2"><?php print_r($response_type) ?></td>
							</tr>																									
						</tbody>
						</table>
