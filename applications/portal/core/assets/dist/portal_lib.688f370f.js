...
//     }
    ...
    // Requires jQuery!
    jQuery.ajax({
        url: "https://jira.ardc.edu.au/plugins/servlet/issueCollectorBootstrap.js?collectorId=4d89e3f4&locale=en_UK",
        type: "get",
        cache: true,
        dataType: "script",
        headers: {
            "X-FRAME-Options":"ALLOW FROM https://jira.ardc.edu.au"
        }
    });
