...
?>
<div id="banner-image" class="background-media" style="background-image: url({{$banner}}); background-size: cover; background-position: 50% 65%; background-repeat: no-repeat;  box-shadow: none;">
</div>
