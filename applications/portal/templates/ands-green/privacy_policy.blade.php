       ...
       <div class="container">
           <div class="row">
               <div class="col-md-12">
                   ...
                   <p>
                       For each visitor to reach the site, we collect non-personally identifiable information, including
                       but not limited to browser type, version and language, operating system, pages viewed while
                       browsing the site, page access times, search terms used and referring website address.
                   </p>
                   <h3>Use of non-personally identifiable information</h3>
                   <p>
                       The non-personally identifiable information collected will be used for the purpose of gauging
                       visitor traffic, trends analysis and delivering personalised content to you while you are at the
                       site.  We will also use the aggregated data, in its entirety or in a time-based scale, to provide
                       statistics to our users and our partners. These statistics can either be displayed in Research
                       Data Australia (e.g. views, access) or as a report shared with our partners and stakeholders.
                   </p>
                   ...
                   <p>
                       ...
                       we will update this policy, and  only data collected from the time of the policy change will be
                       used  for those new purposes.
                   </p>
