                ...
                @foreach($subjects as $col)
                    @if(isset($col['resolved']) && $col['subject']!='')
                        @if($col['type']=='anzsrc-for')
                            <a href="{{base_url().'search/#!/anzsrc-for='.$col['subject'].$classSearchComp}}"><span  itemprop="about keywords">{{ titleCase($col['resolved']) }}</span></a> |
                        @elseif($col['type']=='anzsrc-seo')
                            <a href="{{base_url().'search/#!/anzsrc-seo='.$col['subject'].$classSearchComp}}"><span  itemprop="about keywords">{{ titleCase($col['resolved']) }}</span></a> |
                        @else
