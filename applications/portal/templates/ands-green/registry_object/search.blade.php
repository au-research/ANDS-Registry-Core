   ...
   <!--<div class="panel-body swatch-white">
    ...
    <div class="panel-body swatch-white">
        <div ng-repeat="(name, value) in filters" ng-if="showFilter(name)">
            ...
            <ul class="listy no-bottom" ng-show="isArray(value)===false && (name!='anzsrc-for' && name!='anzsrc-seo' && name!='anzsrc-for-2020' && name!='anzsrc-seo-2020') && name!='nottype'">
                <li>
                    <a href="" ng-click="toggleFilter(name, value, true)">
                        <span ng-if="name!='related_object_id'">[[ value | formatFacet | truncate:30  ]]</span>
            ...
            <div resolve ng-if="name=='anzsrc-for-2020'" subjects="value" vocab="'anzsrc-for-2020'"></div>
            <div resolve ng-if="name=='anzsrc-seo'" subjects="value" vocab="'anzsrc-seo'"></div>
            <div resolve ng-if="name=='anzsrc-seo-2020'" subjects="value" vocab="'anzsrc-seo-2020'"></div>
        </div>
        <div ng-repeat="(name, value) in filters" ng-if="showFilter(name)">
