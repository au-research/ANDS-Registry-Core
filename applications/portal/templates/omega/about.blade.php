...
<article>
	<section class="section swatch-white element-normal-bottom">
       <div class="container-fluid">
           <div class="row">
               <div class="col-md-12 text-center not-condensed os-animation animated fadeInUp swatch-gray" style="-webkit-animation: 0s;padding-top:50px;padding-bottom:50px;">
               ...
               <div class="col-md-12 not-condensed os-animation animated fadeInUp" style="-webkit-animation: 0s;padding-top:30px;padding-bottom:50px">
                   <div class="text-center" style="-webkit-animation: 0s;">
                        <p class="strong hairline bordered bordered-normal os-animation animated fadeIn" data-os-animation="fadeIn" data-os-animation-delay="0s" style="-webkit-animation: 0s;color:#000000"><strong>Why make data discoverable?</strong></p>
                   </div>
               ...
               <div class="col-md-12 not-condensed os-animation animated fadeInUp  swatch-gray" style="-webkit-animation: 0s;padding-top:20px;padding-bottom:20px;text-decoration-color: #ffffff">
               ...
               <div class="col-md-4" style="float:right;padding-left:20px;padding-top:100px" >
               ...
               <div class="col-md-12 not-condensed os-animation animated fadeInUp swatch-gray" style="-webkit-animation: 0s;padding-top:50px;padding-bottom:50px">
                   <div class="text-left" style="-webkit-animation: 0s;padding-left:50px;padding-right:50px;">
    <ul>
                       ...
                       <p>
                       <ul  class="fa-ul" >
                           <li ><i class="fa-li fa  fa-lightbulb-o" ></i>
