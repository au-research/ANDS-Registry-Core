                ...
                <div class="panel-body swatch-white">
                    ...
                    <p>
                        ...
                        ?>
                            ...
                            <i class="fa fa-folder-open icon-portal"></i> <small>{{readable($col['relation_type'],$col['origin'],$ro->core['class'])}}</small> <a href="<?php echo base_url()?>{{$col['slug']}}/{{$col['registry_object_id']}}" title="{{$col['title']}}" {{$description}} class="ro_preview" ro_id="{{$col['registry_object_id']}}">{{$col['title']}}</a><br />
                            @elseif(isset($col['identifier_relation_id']))
                            <i class="fa fa-folder-open icon-portal"></i> <small>{{readable($col['relation_type'],$col['origin'],$ro->core['class'])}}</small> <a href="<?php echo base_url()?>" title="{{$col['title']}}" {{$description}} class="ro_preview" identifier_relation_id="{{$col['identifier_relation_id']}}">{{$col['title']}}</a><br/>
                            @endif
                        @endforeach
                    </p>
                    @endif
                    ...
                    <p>
                        ...
                        ?>
                            @if($col['slug'] && $col['registry_object_id'])
                            <i class="fa fa-folder-open icon-portal"></i> <small>{{readable($col['relation_type'],$col['origin'],$ro->core['class'])}}</small> <a href="<?php echo base_url()?>{{$col['slug']}}/{{$col['registry_object_id']}}" title="{{$col['title']}}" class="ro_preview" {{$description}} ro_id="{{$col['registry_object_id']}}">{{$col['title']}}</a><br />
                            @elseif(isset($col['identifier_relation_id']))
                            <i class="fa fa-folder-open icon-portal"></i> <small>{{readable($col['relation_type'],$col['origin'],$ro->core['class'])}}</small> <a href="<?php echo base_url()?>" title="{{$col['title']}}" class="ro_preview" {{$description}} identifier_relation_id="{{$col['identifier_relation_id']}}">{{$col['title']}}</a><br/>
                            @endif
                        @endforeach
                    ...
                    <p>
                        ...
                        ?>
                            @if($col['slug'] && $col['registry_object_id'])
                            <i class="fa fa-group icon-portal"></i> <small>{{readable($col['relation_type'],$col['origin'],$ro->core['class'])}}</small> <a href="<?php echo base_url()?>{{$col['slug']}}/{{$col['registry_object_id']}}" title="{{$col['title']}}" class="ro_preview" {{$description}} ro_id="{{$col['registry_object_id']}}">{{$col['title']}}</a><br/>
                            @elseif(isset($col['identifier_relation_id']))
                            <i class="fa fa-group icon-portal"></i> <small>{{readable($col['relation_type'],$col['origin'],$ro->core['class'])}}</small> <a href="<?php echo base_url()?>" title="{{$col['title']}}" class="ro_preview" {{$description}} identifier_relation_id="{{$col['identifier_relation_id']}}">{{$col['title']}}</a><br/>
                            @endif
                        <?php } ?>
                        @endforeach
                   ...
                   <p>
                       ...
                       ?>
                           @if($col['slug'] && $col['registry_object_id'])
                           <i class="fa fa-flask icon-portal"></i> <small>{{readable($col['relation_type'],$col['origin'],$ro->core['class'])}}</small> <a href="<?php echo base_url()?>{{$col['slug']}}/{{$col['registry_object_id']}}" title="{{$col['title']}}" class="ro_preview" {{$description}} ro_id="{{$col['registry_object_id']}}">{{$col['title']}}</a><br />
                           @elseif(isset($col['identifier_relation_id']))
                           <i class="fa fa-flask icon-portal"></i> <small>{{readable($col['relation_type'],$col['origin'],$ro->core['class'])}}</small> <a href="<?php echo base_url()?>" title="{{$col['title']}}" class="ro_preview" {{$description}} identifier_relation_id="{{$col['identifier_relation_id']}}">{{$col['title']}}</a><br/>
                           @endif
                        @endforeach
                    ...
                    <p>
                        ...
                        ?>
                            @if($col['slug'] && $col['registry_object_id'])
                            <i class="fa fa-wrench icon-portal"></i> <small>{{readable($col['relation_type'],$col['origin'],$ro->core['class'])}}</small> <a href="<?php echo base_url()?>{{$col['slug']}}/{{$col['registry_object_id']}}" title="{{$col['title']}}" class="ro_preview" {{$description}} ro_id="{{$col['registry_object_id']}}">{{$col['title']}}</a><br/>
                            @elseif(isset($col['identifier_relation_id']))
                            <i class="fa fa-wrench icon-portal"></i> <small>{{readable($col['relation_type'],$col['origin'],$ro->core['class'])}}</small> <a href="<?php echo base_url()?>" title="{{$col['title']}}" class="ro_preview" {{$description}} identifier_relation_id="{{$col['identifier_relation_id']}}">{{$col['title']}}</a><br/>
                            @endif
                        @endforeach
