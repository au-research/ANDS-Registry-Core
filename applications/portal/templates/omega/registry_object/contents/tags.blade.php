<div class="panel panel-primary panel-content swatch-white" ng-controller="tagController">
    ...
    <div class="panel-body swatch-white">
               <h3>User Contributed Tags &nbsp;&nbsp;&nbsp;<a href="#" title="User tags are terms added to records by Research Data Australia users to assist discovery of these records by themselves and others. By clicking on an added tag you can discover other related records with the same tag.
