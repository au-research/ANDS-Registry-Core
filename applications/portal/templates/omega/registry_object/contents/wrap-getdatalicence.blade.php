    ...
    <div class="panel-body">
        ...
        <div>
        	...
        	@elseif($ar=='conditional')
                <a href="" tip="Online or offline data that can be accessed free of charge, providing certain conditions are met (e.g. free registration is required to access data online)"><span class="label label-info label-{{$ar}}" for="">CONDITIONAL</span></a>
            @elseif($ar=='restricted')
                <a href="" tip="Online or offline data where access to the data is limited in some way (e.g. access is only available to a particular group of users"><span class="label label-info label-{{$ar}}" for="">RESTRICTED</span></a>
            @endif
