            ...
            <div class="row">
                ...
                <div class="element-no-top element-no-bottom" ng-class="{'col-md-8':filters.spatial}">
                    ...
                    <div class="scontent" myWidth>
                        ...
                        <p><small>[[doc.group]]</small> <small ng-if="filters.class=='activity' && doc.earliest_year"><span style="padding-left:15px"></span><strong>[[doc.earliest_year]]-[[doc.latest_year]]</strong></small></p>
