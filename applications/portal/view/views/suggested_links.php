...
if ($suggested_links_contents)
{
	...
	if ($suggested_links_contents['identifiers'] && $suggested_links_contents['identifiers']['count'] > 0)
	{
		...
		$output .= '<h5><a href="#" class="" data-title="Records with matching identifiers" data-suggestor="ands_identifiers" data-start="0" data-rows="10" relation_type="identifier" ng-click="open($event)">'.$suggested_links_contents['identifiers']['count'].' '.$count_str.'</a> with matching identifiers</h5>';
	...
	if ($suggested_links_contents['subjects'] && $suggested_links_contents['subjects']['count'] > 0)
	{
		...
		$output .= '<h5><a href="#" class="" data-title="Records with matching subjects" data-suggestor="ands_subjects" data-start="0" data-rows="10" relation_type="subject" ng-click="open($event)">'.$suggested_links_contents['subjects']['count'].' '.$count_str.'</a> with matching subjects</h5>';
