			...
			<div class="row">
				<div class="col-md-8"> 
					<div class="panel swatch-gray">
						...
						<div class="panel-body">
							<div class="form-group" ng-class="{ 'has-error' : form.cms.title.$invalid  && !form.cms.title.$pristine}">
								...
								<p ng-show="form.cms.title.$invalid && !form.cms.title.$pristine" class="help-block">Vocabulary Title is required.</p>
							</div>
							<div class="form-group" ng-class="{ 'has-error' : form.cms.description.$invalid  && !form.cms.description.$pristine}">
								...
								<p ng-show="form.cms.description.$invalid && !form.cms.description.$pristine" class="help-block">Vocabulary Description is required.</p>
							</div>
							<div class="form-group">
							...
							<div class="form-group" ng-class="{ 'has-error' : form.cms.creation_date.$invalid  && !form.cms.creation_date.$pristine}">
								<label for="">Vocabulary Creation Date</label>
								<p class="input-group">
									<input type="text" class="form-control" required ng-model="vocab.creation_date" placeholder="Vocabulary Creation Date" datepicker-popup="dd-MM-yyyy" is-open="opened" >
									<span class="input-group-btn">
										<button type="button" class="btn btn-default" ng-click="open($event)"><i class="glyphicon glyphicon-calendar"></i></button>
									</span>
								</p>
								<p ng-show="form.cms.creation_date.$invalid && !form.cms.creation_date.$pristine" class="help-block">Vocabulary Creation Date is required.</p>
							</div>
							<div class="form-group">
