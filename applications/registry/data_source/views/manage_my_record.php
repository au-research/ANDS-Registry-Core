...
<div id="content" style="margin-left:0px">
	...
	<div id="breadcrumb">
		<div class="pull-right">
			...
			<span class="label"><i class="icon-question-sign icon-white"></i> <a target="_blank" style="color:white;" href="https://documentation.ardc.edu.au/display/DOC/Manage+Records"> Help</a></span>
		</div>
