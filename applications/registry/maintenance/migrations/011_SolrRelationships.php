...
class SolrRelationships extends GenericSolrMigration
{
    ...
    public function __construct()
    {
        ...
        $this->setFields([
            ...
            ['name' => 'related_collection_search', 'type' => 'text_en_splitting', 'stored' => true, 'indexed' => true, 'multiValued' => true],
            ...
            ['name' => 'related_party_one_search', 'type' => 'text_en_splitting', 'stored' => true, 'indexed' => true, 'multiValued' => true],
            ...
            ['name' => 'related_party_multi_search', 'type' => 'text_en_splitting', 'stored' => true, 'indexed' => true, 'multiValued' => true],
            ...
            ['name' => 'related_activity_search', 'type' => 'text_en_splitting', 'stored' => true, 'indexed' => true, 'multiValued' => true],
            ...
            ['name' => 'related_service_search', 'type' => 'text_en_splitting', 'stored' => true, 'indexed' => true, 'multiValued' => true],
        ]);
