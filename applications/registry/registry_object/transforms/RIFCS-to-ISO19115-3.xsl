...
<xsl:stylesheet version="1.0"
    ...
    <!-- stylesheet to convert Flatened WxS Capabilities xml to ISO19115-3 service record -->
            ...
            <mdb:identificationInfo>
                <srv:SV_ServiceIdentification>
                    ...
                    <mri:resourceSpecificUsage>
                        <mri:MD_Usage>
                            <mri:specificUsage><gco:CharacterString>resourceSpecificUsage</gco:CharacterString></mri:specificUsage>
                        </mri:MD_Usage>
                    </mri:resourceSpecificUsage>
                    <mri:resourceConstraints>
                        <mco:MD_Constraints><mco:useLimitation><gco:CharacterString>resourceConstraints</gco:CharacterString></mco:useLimitation></mco:MD_Constraints>
                    </mri:resourceConstraints>
                    <srv:serviceType><gco:ScopedName>ServiceType</gco:ScopedName></srv:serviceType>
                    <!--
                           END FILL
                                        -->
    ...
    <xsl:template match="ro:spatial">
        ...
        <!--xsl:message><xsl:value-of select="$lowText"></xsl:value-of></xsl:message-->
        <!--spatial type="iso19139dcmiBox">northlimit=-10.05; southlimit=-43.95; westlimit=112.05; eastLimit=153.95; projection=WGS84</spatial-->
        <mri:extent>
            <gex:EX_Extent>
