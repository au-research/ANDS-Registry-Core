...
return [
    ...
    'doi_link_checker_script' => env('DOI_LINK_CHECKER_SCRIPT','/opt/apps/registry/current/etc/misc/python/linkchecker/linkchecker.py --html_output -i /opt/ands/registry/etc/misc/python/linkchecker/linkchecker.ini -m DOI'),
    'storage' => [
        'test' => [
            'driver' => 'file',
