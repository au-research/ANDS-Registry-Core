...
<?php if($oauth_conf['providers']['Twitter']['enabled']): ?>
    <a href="<?php echo registry_url('auth/authenticate/twitter'); ?>?redirect=<?php echo $this->input->get('redirect') ?>" class="btn btn-primary btn-block btn-icon-left">Login with X (formerly Twitter) <span><i class="fa fa-twitter"></i></span></a>
<?php endif; ?>
