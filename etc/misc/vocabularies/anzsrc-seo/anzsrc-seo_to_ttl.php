...
$concepts = array();
define('CONCEPT_NAMESPACE', 'http://purl.org/au-research/vocabulary/anzsrc-seo/2008/');
define('CONCEPTSCHEME_PREFLABEL', '"1297.0 - Australian and New Zealand Standard Research Classification (ANZSRC), 2008 - Socio-Economic Objective Codes"@en');
define('CONCEPTSCHEME_ALTLABEL', '"Socio-Economic Objective Codes"@en');


// Parse the values from the ABS csv file
if (($handle = fopen("ANZSRC-SEO-CODES.csv", "r")) !== FALSE) {
